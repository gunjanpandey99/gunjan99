...
public class IOSScrollTest extends IOSBaseTest {
	...
	//	WebElement ele=driver.findElement(By.xpath("//*[@label='Alerts']"));
		driver.findElement(By.xpath("//*[@label='Alerts']")).click();
		WebElement ele=driver.findElement(By.xpath("//*[@label='Secure Text Input']"));
		Map<String,Object> params =new HashMap<>();
		params.put("element",((RemoteWebElement)ele).getId());
		params.put("direction","down");
         driver.executeScript("mobile:scroll", params);
         //driver.findElement(By.xpath("//*[@label='Secure Text Input']")).click();
         Thread.sleep(2000);
 		driver.findElement(By.xpath("//*[@label='Secure Text Input']")).click();
